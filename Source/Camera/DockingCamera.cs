...
namespace OLDD_camera.Camera
{
    class DockingCamera : BaseCamera
    {
        ...
        public DockingCamera(Part thisPart, bool noise, bool crossStock, bool crossDPAI, bool crossOLDD, int windowSize, string windowLabel = "DockCam", string cameraNodeName = "dockingNode")
            : base(thisPart, windowSize, windowLabel)
        {
            ...
            if(cameraNodeName != "dockingNode")
                _moduleDockingNodeGameObject = (GameObjectExtension.GetChild(PartGameObject, cameraNodeName) ?? PartGameObject);  //GET orientation from dockingnode
            else
