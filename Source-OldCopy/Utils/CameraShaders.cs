...
namespace OLDD_camera.Utils
{
    ...
    {
        OldTV,              // Custom/CRT
        NightVisionNoise1,  // Hidden/NightVision
        Noise,          // none
        NoiseNightVision,   // Custom/NightVision (not working, all black)
        NightVisionClear,   // NightVisionClear
        Grayscale,          // Custom/MovieTime
        None
    }
